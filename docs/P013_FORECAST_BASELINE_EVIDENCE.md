...
- **Compared methods:** the baseline versus **repeat-last-day** (each hour
  ...
  identical hours.
- **Metrics:** MAE (kWh per hour) and aggregate energy error per origin
  (predicted total − actual total, kWh). No percentages.
...
Measured output (`.venv\Scripts\python.exe scripts\evaluate_forecast_baseline.py`):
  ...
  "horizons": {
    "next_24h": {
      ...
      "baseline": {
        ...
        "mean_abs_aggregate_error_kwh_per_origin": 0.791,
        "mean_aggregate_error_kwh_per_origin": -0.063
      },
      "repeat_last_day": {
        "hours_scored": 639,
        "mae_kwh_per_hour": 0.7018,
        "mean_abs_aggregate_error_kwh_per_origin": 13.635,
        "mean_aggregate_error_kwh_per_origin": -0.006
      }
    },
    "next_7d": {
      "origins": 4,
      "baseline": {
        ...
        "mean_abs_aggregate_error_kwh_per_origin": 1.117,
        "mean_aggregate_error_kwh_per_origin": -0.429
      },
      "repeat_last_day": {
        "hours_scored": 639,
        "mae_kwh_per_hour": 1.3702,
        "mean_abs_aggregate_error_kwh_per_origin": 214.833,
        "mean_aggregate_error_kwh_per_origin": -214.833
      }
    },
    "next_calendar_month": {
      "origins": 2,
      "baseline": {
        ...
        "mean_abs_aggregate_error_kwh_per_origin": 2.364,
        "mean_aggregate_error_kwh_per_origin": 0.648
      },
      "repeat_last_day": {
        "hours_scored": 1343,
        "mae_kwh_per_hour": 0.7765,
        "mean_abs_aggregate_error_kwh_per_origin": 320.639,
        "mean_aggregate_error_kwh_per_origin": 320.639
      }
    }
  }
}
...
| Horizon (origins) | Hours scored | Baseline MAE kWh/h | Repeat-last-day MAE kWh/h | Baseline mean abs aggregate error / origin | Repeat-last-day mean abs aggregate error / origin |
|---|---|---|---|---|---|
| next_24h (28) | 639 | 0.1223 | 0.7018 | 0.791 kWh | 13.635 kWh |
| next_7d (4) | 639 | 0.1218 | 1.3702 | 1.117 kWh | 214.833 kWh |
| next_calendar_month (2) | 1343 | 0.1239 | 0.7765 | 2.364 kWh | 320.639 kWh |
